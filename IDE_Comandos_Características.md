...
Conceptos:
- Break point (puntos de interrupción o de ruptura): Son lugares específicos del código donde el IDE se va a detener, va a pausar la ejecución para que podamos inspeccionar el estado del programa en ese punto. De esta manera seguiremos el código paso a paso con conceptos como:
